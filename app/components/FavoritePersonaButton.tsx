    ...
    return (
        <div>
            <button
                ...
                disabled={loading}
                className={`flex min-h-28 w-full items-center justify-center rounded-lg border px-2 py-3 text-[10px] font-bold uppercase tracking-[0.18em] transition-colors disabled:cursor-wait disabled:opacity-60 ${favorite
