...
const translations = {
    ...
    es: {
        ...
        processing: "PROCESANDO...", continue: "CONTINUAR", haveAccess: "¿Ya tienes acceso? Entrar",
    ...
    en: {
        ...
        processing: "PROCESSING...", continue: "CONTINUE", haveAccess: "Already have access? Sign in",
